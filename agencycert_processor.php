        ...
        if (isset($_FILES['uploadedFile']))
        {
            ...
            if (empty($errors))
            {
				...
				if(move_uploaded_file($file_tmp, $file))
				{
                    ...
                    echo "The PDF URL is $certpdfurlAutogenerated<br/>";
				}
                ...
                if(strlen($valueList) < 1)
                {
                    ...
                    $valueList = "'". $certpdfurlAutogenerated."'";
                }
                else
                {
                    //$valueList = "".$valueList.", '".$queryArray['certpdfurl']."'";
                    $valueList = "".$valueList.", '".$certpdfurlAutogenerated."'";
