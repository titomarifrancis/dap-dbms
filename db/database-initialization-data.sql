...
--approveddate - NOW()
--creationdate - NOW()
insert into systemusers(lastname, firstname, usrname, usrpassword, usrpasswordsalt, userlevelid, isapproved, approveddate, creationdate) values('Escano', 'Tito Mari Francis', 'titomarifrancis', 'Em0JK6BNzjQAQ', 'Em6zOOLcxoJmK2xb9kZkV', '3', true, 'NOW()', 'NOW()');
